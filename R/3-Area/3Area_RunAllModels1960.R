...
fixed_gear_with_imputation = readRDS(file = here(dat_path, "fixed_gear_with_imputations_S1.RDS"))
trawl_gear_with_imputation = readRDS(file = here(dat_path, "trawl_gear_with_imputations_S1.RDS"))
...
scenario = paste0("1960_NoTagData", ifelse(AF_direct_ageing, "a", ""))
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("1960_NoTagData_regrecruit", ifelse(AF_direct_ageing, "a", ""))
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("1960_TagData_01", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_3A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("1960_TagData_01_alt", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_3A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
if(read_in_previous_model_data_and_params) {
  previous_scenario = paste0("1960_TagData_01", ifelse(AF_direct_ageing, "a", ""))
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("1960_TagData_02", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_3A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("1960_TagData_03", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_3A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("1960_Model_02", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_3A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
## so set = 0.5
parameters$trans_fixed_catchatlgth_error = log(0.15) # which was the estimated value for trawl LF
