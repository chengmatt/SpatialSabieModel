# Purpose: To make a universal script that creates data inputs for 3 area models with a model
...
max_N_eff = 500 / 3 # Maximum input sample size
min_N_eff = 50 / 3 # Minimum input sample size
...
# Define Kari's 3-area movement matrix
...
full_catch_df = full_catch_df %>% filter(year %in% years) # 1977 - terminal, region specific catches
...
# convert catches to metric tonnes
