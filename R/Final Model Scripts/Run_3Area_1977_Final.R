# Purpose: Run 3-Area model as a final model for comparison 1977
...
parameters$ln_sigma_init_devs = log(1.2) # change sigma init starting value 
...
srv_sel_second_param_shared_by_sex = c(F,T)
