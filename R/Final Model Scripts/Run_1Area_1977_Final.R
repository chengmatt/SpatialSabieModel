# Purpose: Run 1-Area model as a final model for comparison 1977
...
fig_path = here("Figs", "1-Area-1977")
out_path = here("Output", "Final Models", "1-Area-1977")
...
model_path = here("Output", "Final Models", "1-Area-1977", "1-Area-1977-Final")
...
parameters$ln_sigma_init_devs = log(1.2) # change sigma init
