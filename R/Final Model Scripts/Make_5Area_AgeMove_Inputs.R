# Purpose: To make data inputs for 5-area age based movement models 
...
saveRDS(data, file.path(out_path, "data_5area_agemove.RDS"))
saveRDS(parameters, file.path(out_path, "parameters_5area_agemove.RDS"))
