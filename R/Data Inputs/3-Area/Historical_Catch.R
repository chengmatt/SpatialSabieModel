...
## Read in Catch
catch_post_90 = read.csv(file = here("Data", "Raw", "raw_catch_file.csv"))
catch_90 <- read.csv(here("Data", "Inputs","1990 catch.csv"),header=T)
...
hist_catch_lng = hist_catch_lng %>% mutate(area = case_when(area == "EGOA"  ~ "EGOA",
                                                          area   == "CGOA"  ~ "CGOA",
                                                          TRUE ~ "BS_AI_WGOA"))
...
ggsave(filename = here("Figs", "3-Area", "Fixed_gear_catch_area_imputation_bzero_simulation.png"), width = 10, height =7)
...
ggsave(filename = file.path("Figs", "3-Area", "Trawl_gear_catch_area_imputation_bzero_simulation.png"), width = 10, height =7)
...
## save to data
saveRDS(fixed_gear_with_imputations_S1,file = here("Data", "3-Area", "fixed_gear_with_imputations_S1.RDS"))
saveRDS(fixed_gear_with_imputations_S2,file = here("Data", "3-Area",  "fixed_gear_with_imputations_S2.RDS"))
saveRDS(trawl_gear_with_imputations_S1,file = here("Data", "3-Area",  "trawl_gear_with_imputations_S1.RDS"))
saveRDS(trawl_gear_with_imputations_S2,file = here("Data", "3-Area", "trawl_gear_with_imputations_S2.RDS"))
