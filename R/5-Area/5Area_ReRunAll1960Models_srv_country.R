...
fixed_gear_AF_alk_pooled = readRDS(file = file.path("Data", "5-Area", "Observer_ALK_AF_w_eff.RDS"))
fixed_gear_AF_direct = readRDS(file = file.path("Data", "5-Area", "Observer_direct_AF_w_eff.RDS"))
trawl_observer_LF = readRDS(file = file.path("Data", "5-Area", "Observer_trawl_LF_w_eff.RDS"))
fixed_observer_LF = readRDS(file = file.path("Data", "5-Area", "Observer_fixed_LF_w_eff.RDS"))
...
## Tag data
tag_recovery_df = readRDS(file = file.path("Data", "5-Area", "Tag_recovery_summarised.RDS"))
tag_release_df = readRDS(file = file.path("Data", "5-Area", "Tag_release_summarised.RDS"))

## read in Catch
full_catch_df = readRDS(file = file.path("Data", "5-Area", "Catch_by_year_area_gear.RDS"))

fixed_gear_with_imputation = readRDS(file = file.path("Data", "5-Area", "fixed_gear_with_imputations_S1.RDS"))
trawl_gear_with_imputation = readRDS(file = file.path("Data", "5-Area", "trawl_gear_with_imputations_S1.RDS"))
...
scenario = paste0("Model1960_01_srv", ifelse(AF_direct_ageing, "a", ""))
...
rec_devs_not_to_estimate = c(1960:1985, 2018:2021)

data$rec_devs_sum_to_zero 
data$global_rec_devs 
data$prop_F_hist
...
######################
## First model run Model1960_01a
## Estiamte all recruit devs, but force them to sum = 0
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_01a_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
## Est decadal tag-reporting
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_02_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_03_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
trawl_gear_with_imputation = readRDS(file = file.path("Data", "5-Area", "trawl_gear_with_imputations_S2.RDS"))
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_05_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_06_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
