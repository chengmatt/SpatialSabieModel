...
scenario = paste0("Model1977_01_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
recruit_dev_years_not_to_estimate = c(1960:1975, 2019:2021)
## check parameters
...
######################
scenario = paste0("Model1977_02_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
scenario = paste0("Model1977_03_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
map_fixed_pars = set_up_parameters(data = data, parameters = parameters,
                                   ...
                                   trwl_sel_first_shared_by_sex  = trwl_sel_first_shared_by_sex,
                                   trwl_sel_second_shared_by_sex  = trwl_sel_second_shared_by_sex,
                                   recruit_dev_years_not_to_estimate = NULL,# recruit_dev_years_not_to_estimate,  ## don't estimate the last one
                                   srv_q_spatial = srv_q_spatial,
                                   tag_reporting_rate = tag_reporting_rate,
                                   est_init_F = est_init_F,
                                   est_catch_sd = est_catch_sd,
...
plot_recruitment(start_report)
restoresimplex(start_report$recruitment_devs[1,])
#exp(start_report$recruitment_devs[1,] - 0.5 * data$sigma_R^2)
#start_report$recruitment_multipliers[1,]
...
######################
scenario = paste0("Model1977_04_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
scenario = paste0("Model1977_05_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
scenario = paste0("Model1977_06_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
scenario = paste0("Model1977_07_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
if(read_in_previous_model_data_and_params) {
  previous_scenario = paste0("Model1977_06_srv", ifelse(AF_direct_ageing, "a", ""))
...
######################
scenario = paste0("Model1977_08_srv", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path("Output", "5-Area", scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
read_in_previous_model_data_and_params = T
if(read_in_previous_model_data_and_params) {
  previous_scenario = paste0("Model1977_07_srv", ifelse(AF_direct_ageing, "a", ""))
  previous_fig_path = file.path("Output", "5-Area", previous_scenario)
  data = readRDS(file.path(previous_fig_path, "data.RDS"))
  parameters = readRDS(file.path(previous_fig_path, "parameters.RDS"))
