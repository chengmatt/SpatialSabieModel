...
if(dim(parameters$ln_fixed_sel_pars)[1] == 1){
...
} else if(dim(parameters$ln_fixed_sel_pars)[1] == 3){
...
######################
## First model run Model1960_01
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_01", ifelse(AF_direct_ageing, "a", ""))
...
######################
## First model run Model1960_02
## Est rec devs back to 1970
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_02", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_5A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_03", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_5A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_04", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_5A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_05", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_5A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
...
######################
# options(warn=0) ## if warnings are being set to errors
scenario = paste0("Model1960_06", ifelse(AF_direct_ageing, "a", ""))
fig_path = file.path(DIR$app_5A, scenario)
if(!dir.exists(fig_path)) {
  dir.create(fig_path)
}
